...
class Meeting extends StatefulWidget {
  ...
  final Event? event;
  const Meeting(
      {Key? key, this.anonymous = false, this.isFromSearch = false, this.event})
      : super(key: key);
  ...
  asyncTask() {
    ...
    setState(() {
      ...
      if (widget.event != null) {
        subjectText.text = widget.event!.getTopic;
        roomText.text = 'room' + widget.event!.eid;
      }
    });
  }
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          if (widget.isFromSearch || widget.anonymous)
            TextField(
          ...
          if (widget.event == null) ...[
            TextFormField(
              ...
              initialValue: widget.event != null
                  ? widget.event!.getTopic + widget.event!.eid
                  : null,
              decoration: InputDecoration(
                border: OutlineInputBorder(),
                labelText: "Room",
